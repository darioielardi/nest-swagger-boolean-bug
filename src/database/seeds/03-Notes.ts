...
export async function seed(knex: Knex): Promise<any> {
  await Note.query(knex).insert([
    ...
    {
      text:
        'Ab animi at consectetur error ex fugiat magni minima minus reiciendis sapiente?',
      themeId: 1,
    },
    {
      text:
    ...
    {
      text:
        'Ab autem debitis dicta et illum minima molestiae non nostrum similique veniam.',
      themeId: 3,
    },
  ]);
}
